...
import com.github.threads.DirectoryParser;
    ...
    public MainForm() {
        ...
        btnParse.addActionListener(e -> {
            ...
            if (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                File[] fileList = fileChooser.getSelectedFile().listFiles();
                ...
                if (!CollectionUtils.isEmpty(directories)) {
                    DirectoryParser directoryParser = new DirectoryParser(directories);
